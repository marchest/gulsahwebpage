<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="gulsahWebProj.index" %>


<!DOCTYPE html>
<html lang="en">
<head>
<title>Gulsah Samut</title>
...
<body>
	...
	<div class="banner-agile">
		<div class="logo-w3layouts">
			<h1><a href="/">Personal Resume</a></h1>
		</div>	
		<div class="container">
			<div class="banner-info-w3l">
				<h3>Welcome</h3>
				<h2>Hi,I am Gulsah Samut</h2>
				...
				<div class="navbar-header">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-right margin-top cl-effect-2">
							<li><a class="scroll2" href="/"><span data-hover="Home">Home</span></a></li>
				...
				<div class="col-md-7 w3ls-agile-left">
					<div class="w3ls-agile-left-info">
						<div class="wel-left animated wow fadeInLeft" data-wow-delay=".5s">
							...
							<div class="text-w3l">
								<h4>WEB DEVELOPER</h4>
								<p>Work with senior developer to manage large, complex design projects for corporate clients.
...
Carry out quality assurance tests to discover errors and optimize usability.</p>
							</div>
							<div class="clearfix"> </div>
						</div>
					</div>
					...
					<div class="w3ls-agile-left-info">
						<div class="wel-left animated wow fadeInLeft" data-wow-delay=".5s">
							...
							<div class="text-w3l">
								...
								<p>A highly motivated analyst with vast experience in interpreting, analyzing and reconciliation of data obtained from a variety of sources; skills involve development and enhancement of the existing processes and methods to meet both internal and external analysis requirements; proficient with the prevailing analytical tools, various presentation software and possesses strong and effective communication skills essential in conveying results in analysis and investigations conducted; has great commitment to and affinity to meet deadlines without compromising accuracy and quality of work.</p>
							</div>
							<div class="clearfix"> </div>
						</div>
					</div>
		...
		<div class="container-fluid">
			...
			<div class="wthreeskills-grids">
				<div class="col-md-6 wthreeskills-grid wthreeskills-grid-2">
	                ...
	                <div class="bar_group">
					    <div class='bar_group__bar thin' label='Python' show_values='true' tooltip='true' value='95'></div>
						<div class='bar_group__bar thin' label='R' show_values='true' tooltip='true' value='99'></div>
						<div class='bar_group__bar thin' label='Java' show_values='true' tooltip='true' value='95'></div>
						<div class='bar_group__bar thin' label='C#' show_values='true' tooltip='true' value='95'></div>
						<div class='bar_group__bar thin' label='SQL' show_values='true' tooltip='true' value='95'></div>
					...
					<div class="tabs">
						...
						<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
								<ul class="resp-tabs-list">
									<li class="resp-tab-item"><span>Decision Making</span></li>
									<li class="resp-tab-item"><span>Data Analysis</span></li>
									<li class="resp-tab-item"><span>Agile and Scrum</span></li>
									<li class="resp-tab-item"><span>Leadership</span></li>
									<li class="resp-tab-item"><span>Time Management</span></li>
								</ul>
...
<%--								<div class="resp-tabs-container">
			...
			<div class="services-w3ls-row">
				...
				<div class="col-md-3 services-grids">
					...
					<span class="glyphicon glyphicon-camera" aria-hidden="true"></span>
						...
						<h4 class="mission">Travelling</h4>
						<p class="description">Scelerisque Praesent</p>
					</div>
				</div> 
								...
								<div class="work">
									<div class="work-info"> 
										...
										<div class="col-md-6 work-grid work-right"> 
											<h5>Volunteer  |EVS  |  European Voluntary Service Association  “SALTES” </h5>
											<p>I organized Codea Project in Barcelona for kids to improve their analytical thinking skills  </p>
										</div>
										<div class="clearfix"> </div>
									</div>
									<div class="work-info"> 
										...
										<div class="col-md-6 work-grid work-left work-left2"> 
											<h5>Volunteer  |EVS  |  European Voluntary Service Association  “SALTES”</h5>
											<p>I worked in Morocco in Development Education and Awareness Raising Project to make families more responsible about their children's education life.      </p>
										</div>
										<div class="clearfix"> </div>
									</div>
									<div class="work-info"> 
										<div class="col-md-6 work-grid work-left"> 
											<h4>2015 June- 2015 October</h4>
										</div>
										<div class="col-md-6 work-grid work-right"> 
											<h5 class="comp"> Junior Software Developer  |Koc Holding </h5>
											<p>I was working  as a software developer at Koc Holding. I was doing maintenance and development for “teknosa.com” by using “.Net” technology. </p>
										</div>
										<div class="clearfix"> </div>
									...
									<div class="work-info"> 
										...
										<div class="col-md-6 work-grid work-left work-left2"> 
											<h5> Internship| Likom Software Company-Middle East  Univerty Technocity  
 </h5>
											<p> I was involved in Likom Gusto ERP, Likom Gusto BPM    Business Process Management and Likom GIZA Business Intelligence Tools Software Software Development / Update and Adaptation Service. The Software Development / Update and Customization Service periodically includes the delivery of versions and sub-releases that include new developments and regulatory changes, and unlimited telephone advice  </p>
										</div>
										<div class="clearfix"> </div>
									</div>
								</div>
  ...
  src="https://www.google.com/maps/embed/v1/place?key=AIzaSyCvYIEA7Mk4u1cMXEGhT5UGjTiJqcrv9W0
    &q=Saint+Etienne" allowfullscreen>
</iframe>
            </div>
			<div class="contact-left-agile">
				...
				<div class="add-w3ls-main">
					...
					<div class="add-w3ls2">
						<h5>Location</h5>
						<p>Rue Victor Duchamp, Saint Etienne</p>
					</div>
					<div class="clearfix"> </div>
				</div>
				<div class="add-w3ls-main">	
					...
					<div class="add-w3ls2">
						<h5>Email</h5>
						<p><a href="mailto:info@example.com">g.samut@hotmail.com</a></p>
					</div>
					<div class="clearfix"> </div>
				</div>
				<div class="add-w3ls-main">	
	...
	<div class="copy-section">
		<div class="container">
			<div class="footer-top">
				<p>© 2017 Personal Resume by Gulsah Samut</a></p>
			</div>
		</div>
	</div>
	<!-- copyright-ends-here -->
